...
enum LibRaw_exceptions
{
  ...
  LIBRAW_EXCEPTION_BAD_PARAMETER = 10,
  LIBRAW_EXCEPTION_INTERNAL_ERROR = 11
};
...
enum LibRaw_callbacks
{
  LIBRAW_CALLBACK_POST_IDENTIFY = 0,
  LIBRAW_CALLBACK_PRE_SUBTRACT = 1,
  LIBRAW_CALLBACK_PRE_SCALECOLORS = 2,
  LIBRAW_CALLBACK_PRE_PREINTERPOLATE = 3,
  LIBRAW_CALLBACK_PRE_INTERPOLATE = 4,
  LIBRAW_CALLBACK_INTERPOLATE_BAYER = 5,
  LIBRAW_CALLBACK_INTERPOLATE_XTRANS = 6,
  LIBRAW_CALLBACK_POST_INTERPOLATE = 7,
  LIBRAW_CALLBACK_PRE_CONVERT_RGB = 8,
  LIBRAW_CALLBACK_POST_CONVERT_RGB = 9,

  LIBRAW_CALLBACK_TOTAL
};
